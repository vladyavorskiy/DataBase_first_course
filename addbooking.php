...
<form action="insertbooking.php" method="post" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label class="form-label">Начало бронирования</label>
        <input type="date" class="form-control" name="start_date">
        <div class="form-text">Введите дату начала бронирования (формат ДД.ММ.ГГГГ)</div>
    </div>

    <div class="mb-3">
        <label class="form-label">Конец бронирования</label>
        <input type="date" class="form-control" name="end_date">
        <div class="form-text">Введите дату конца бронирования (формат ДД.ММ.ГГГГ)</div>
    </div>
